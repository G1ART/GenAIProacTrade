...
def describe_production_boundary() -> dict[str, str | list[str]]:
    ...
    return {
        ...
        "production_scoring_rule": (
            ...
            "research_validation(Phase 15)·validation_campaign(Phase 16)·public_depth(Phase 17)을 읽지 않는다. "
...
def assert_no_auto_promotion_wiring() -> None:
    ...
    if (
        ...
        raise AssertionError(
            ...
            "research_engine/research_validation/validation_campaign/public_depth "
