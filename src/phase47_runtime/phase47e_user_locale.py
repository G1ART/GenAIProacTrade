...
SHELL: dict[str, dict[str, str]] = {
    "ko": {
        ...
        # Product Shell Rebuild v1 Patch 10A — 고객용 표면 (/`) 에서만 쓰이는 키.
        # Ops Cockpit (/ops) 은 기존 shell.* / panel.* / nav.* 를 계속 사용.
        "product_shell.nav.today": "오늘",
        "product_shell.nav.research": "리서치",
        "product_shell.nav.replay": "리플레이",
        "product_shell.nav.ask_ai": "Ask AI",
        "product_shell.loading": "불러오는 중…",
        "product_shell.error.headline": "지금 결과를 불러올 수 없습니다",
        "product_shell.error.body": "잠시 후 다시 시도해 주세요. 이 메시지가 계속되면 운영자에게 문의하세요.",
        "product_shell.error.retry": "다시 시도",
        "product_shell.footer": "METIS — 과장된 확신이 아니라, 정직한 근거를 드리는 것이 원칙입니다.",
        "product_shell.trust_strip.label_tier": "데이터 근거",
        "product_shell.trust_strip.label_last_refresh": "최신 갱신",
        "product_shell.trust_strip.tier.production": "실데이터 파이프라인",
        "product_shell.trust_strip.tier.degraded": "실데이터 + 일부 준비 중",
        "product_shell.trust_strip.tier.sample": "샘플 데모",
        "product_shell.trust_strip.tooltip.production": "실제 시장 데이터로 학습된 모델 번들입니다.",
        "product_shell.trust_strip.tooltip.degraded": "일부 구간은 실데이터 근거이지만, 다른 구간은 아직 준비 중입니다. 제품은 과장된 확신을 드리지 않습니다.",
        "product_shell.trust_strip.tooltip.sample": "이 화면은 샘플 시나리오입니다. 실데이터 번들이 준비되면 자동으로 전환됩니다.",
        "product_shell.glance.title": "오늘의 한 줄 요약",
        "product_shell.hero.cta.open_evidence": "근거 보기",
        "product_shell.hero.cta.open_research": "리서치 열기",
        "product_shell.hero.cta.open_research_hint": "리서치 표면은 Patch 10B에서 정식 재설계됩니다.",
        "product_shell.hero.grade_tooltip": "신호 강도 등급입니다. A+ 가 가장 강하고, F 는 근거가 부족함을 뜻합니다.",
        "product_shell.stance.strong_long": "강한 매수 경향",
        "product_shell.stance.long": "매수 경향",
        "product_shell.stance.neutral": "중립",
        "product_shell.stance.short": "매도 경향",
        "product_shell.stance.strong_short": "강한 매도 경향",
        "product_shell.confidence.live": "실데이터 근거",
        "product_shell.confidence.live_with_caveat": "실데이터 근거 (보조 지표 제한)",
        "product_shell.confidence.sample": "샘플 시나리오",
        "product_shell.confidence.preparing": "실데이터 준비 중",
        "product_shell.evidence.title": "근거 살펴보기",
        "product_shell.evidence.what_changed": "무엇이 바뀌었나",
        "product_shell.evidence.strongest_support": "가장 강한 지지 근거",
        "product_shell.evidence.why_confidence": "이 확신의 근거",
        "product_shell.movers.title": "오늘의 선정된 변동",
        "product_shell.movers.empty": "오늘은 의미 있는 변동이 없습니다.",
        "product_shell.watchlist.title": "내 관심종목",
        "product_shell.watchlist.caption": "관심종목은 참고용 스트립입니다. 상단 히어로 카드가 우선 시각 초점입니다.",
        "product_shell.watchlist.empty": "관심종목을 추가하면 여기에 표시됩니다.",
        "product_shell.advanced.label": "고급 세부 보기",
        "product_shell.advanced.hint": "운영자 전용 세부 로그는 /ops 에서 확인할 수 있습니다.",
        "product_shell.stubs.research.title": "리서치 표면은 재설계 중입니다",
        "product_shell.stubs.replay.title": "리플레이 표면은 재설계 중입니다",
        "product_shell.stubs.ask_ai.title": "Ask AI 는 재설계 중입니다",
        "product_shell.as_of_prefix": "데이터 기준: ",
        "product_shell.research.breadcrumbs_home": "리서치",
        "product_shell.research.landing_title": "오늘의 리서치 관점",
        "product_shell.research.deep_dive_title": "이 종목의 근거를 자세히",
        "product_shell.research.column_top_claims": "이 구간의 대표 관점",
        "product_shell.research.tile_deeplink": "자세히 보기 →",
        "product_shell.research.back_to_landing": "← 리서치로 돌아가기",
        "product_shell.research.claim_title": "이번 관점",
        "product_shell.research.evidence_title": "근거 5가지",
        "product_shell.research.action_title": "다음 행동",
        "product_shell.research.evidence_what": "무엇이 바뀌었나",
        "product_shell.research.evidence_support": "가장 강한 지지",
        "product_shell.research.evidence_counter": "반대·보완 시각",
        "product_shell.research.evidence_missing": "빠졌거나 준비중인 근거",
        "product_shell.research.evidence_peer": "같은 범주의 다른 사례",
        "product_shell.research.action_open_replay": "리플레이로 보기",
        "product_shell.research.action_ask_ai": "Ask AI 에게 더 묻기",
        "product_shell.research.action_back_today": "오늘 화면으로 돌아가기",
        "product_shell.research.empty_tiles": "이 구간에 드릴 만한 관점이 아직 없습니다.",
        "product_shell.research.missing_badge": "준비 중",
        "product_shell.replay.title": "어떻게 여기까지 왔는지",
        "product_shell.replay.summary_events": "이벤트",
        "product_shell.replay.summary_span": "기간",
        "product_shell.replay.timeline_title": "변화의 타임라인",
        "product_shell.replay.scenarios_title": "시나리오 보기",
        "product_shell.replay.scenario_baseline": "현재 근거",
        "product_shell.replay.scenario_weakened": "근거가 약해지면",
        "product_shell.replay.scenario_stressed": "시장이 흔들리면",
        "product_shell.replay.gap_days": "일 공백",
        "product_shell.replay.checkpoint_decision": "결정 지점",
        "product_shell.replay.advanced_label": "원문 페이로드 (민감정보 마스킹됨)",
        "product_shell.replay.advanced_hint": "원본 내부 식별자와 페이로드는 운영자 화면(/ops)에서 확인할 수 있습니다.",
        "product_shell.replay.back_to_today": "오늘 화면으로 돌아가기",
        "product_shell.replay.empty_timeline": "이 종목에 대해 아직 보여드릴 변화 이력이 없습니다.",
        "product_shell.replay.scenario_hint_title": "시나리오는 결정이 아니라 감도 확인입니다.",
        "product_shell.replay.scenario_hint_body": "어떤 시나리오도 매수/매도 권고가 아닙니다.",
        "product_shell.ask.context_prefix": "지금 보고 계신 것",
        "product_shell.ask.quick_title": "자주 묻는 질문",
        "product_shell.ask.freetext_title": "직접 물어보기",
        "product_shell.ask.freetext_placeholder": "예: 이 신호가 왜 이전보다 강해졌나요?",
        "product_shell.ask.submit": "물어보기",
        "product_shell.ask.answer_claim": "요약 답변",
        "product_shell.ask.answer_evidence": "근거",
        "product_shell.ask.answer_missing": "부족한 부분",
        "product_shell.ask.degraded_banner": "지금은 자동 답변 모듈이 준비중입니다. 아래 근거 자료로 안내드립니다.",
        "product_shell.ask.requests_title": "내 요청 현황",
        "product_shell.ask.requests_empty": "아직 보낸 요청이 없습니다.",
        "product_shell.ask.back_to_today": "오늘 화면으로 돌아가기",
        "product_shell.ask.intent.explain_claim": "이 관점을 더 풀어서 설명해줘",
        "product_shell.ask.intent.show_support": "가장 강한 지지 근거는?",
        "product_shell.ask.intent.show_counter": "반대·보완 시각은?",
        "product_shell.ask.intent.other_horizons": "다른 구간은 어떻게 보고 있나?",
        "product_shell.ask.intent.why_confidence": "왜 이 정도 확신인가?",
        "product_shell.ask.intent.whats_missing": "부족한 근거는 무엇인가?",
    ...
    "en": {
        ...
        # Product Shell Rebuild v1 Patch 10A — customer-facing surface (/`) only.
        # The legacy Ops Cockpit (/ops) keeps using shell.* / panel.* / nav.*.
        "product_shell.nav.today": "Today",
        "product_shell.nav.research": "Research",
        "product_shell.nav.replay": "Replay",
        "product_shell.nav.ask_ai": "Ask AI",
        "product_shell.loading": "Loading…",
        "product_shell.error.headline": "We couldn't load results right now",
        "product_shell.error.body": "Please try again in a moment. If this persists, contact an operator.",
        "product_shell.error.retry": "Retry",
        "product_shell.footer": "METIS — honest evidence, not overconfident claims.",
        "product_shell.trust_strip.label_tier": "Data tier",
        "product_shell.trust_strip.label_last_refresh": "Last refresh",
        "product_shell.trust_strip.tier.production": "Live data pipeline",
        "product_shell.trust_strip.tier.degraded": "Live + partial preparing",
        "product_shell.trust_strip.tier.sample": "Sample demo",
        "product_shell.trust_strip.tooltip.production": "Model bundle trained on real market data.",
        "product_shell.trust_strip.tooltip.degraded": "Some horizons are live-derived; others are still preparing. No overconfident claim.",
        "product_shell.trust_strip.tooltip.sample": "This view is a labelled sample scenario; live evidence will replace it when ready.",
        "product_shell.glance.title": "Today at a glance",
        "product_shell.hero.cta.open_evidence": "Open evidence",
        "product_shell.hero.cta.open_research": "Open Research",
        "product_shell.hero.cta.open_research_hint": "Research surface is being rebuilt in Patch 10B.",
        "product_shell.hero.grade_tooltip": "Signal strength grade. A+ is the strongest; F means evidence is insufficient.",
        "product_shell.stance.strong_long": "Strong long bias",
        "product_shell.stance.long": "Long bias",
        "product_shell.stance.neutral": "Neutral",
        "product_shell.stance.short": "Short bias",
        "product_shell.stance.strong_short": "Strong short bias",
        "product_shell.confidence.live": "Live-data evidence",
        "product_shell.confidence.live_with_caveat": "Live with caveats",
        "product_shell.confidence.sample": "Sample scenario",
        "product_shell.confidence.preparing": "Live data preparing",
        "product_shell.evidence.title": "Look inside the evidence",
        "product_shell.evidence.what_changed": "What changed",
        "product_shell.evidence.strongest_support": "Strongest supporting reason",
        "product_shell.evidence.why_confidence": "Why this confidence",
        "product_shell.movers.title": "Selected movers today",
        "product_shell.movers.empty": "No material movers today.",
        "product_shell.watchlist.title": "Your watchlist",
        "product_shell.watchlist.caption": "Watchlist is a reference strip — hero cards above hold the primary focus.",
        "product_shell.watchlist.empty": "Add tickers to your watchlist to see them here.",
        "product_shell.advanced.label": "Advanced details",
        "product_shell.advanced.hint": "Operator-only detail is available at /ops.",
        "product_shell.stubs.research.title": "Research surface is being rebuilt",
        "product_shell.stubs.replay.title": "Replay surface is being rebuilt",
        "product_shell.stubs.ask_ai.title": "Ask AI is being rebuilt",
        "product_shell.as_of_prefix": "Data as of: ",
        "product_shell.research.breadcrumbs_home": "Research",
        "product_shell.research.landing_title": "Today's research perspectives",
        "product_shell.research.deep_dive_title": "A closer look at this thesis",
        "product_shell.research.column_top_claims": "Top claims in this horizon",
        "product_shell.research.tile_deeplink": "See detail →",
        "product_shell.research.back_to_landing": "← Back to research",
        "product_shell.research.claim_title": "This perspective",
        "product_shell.research.evidence_title": "Five pieces of evidence",
        "product_shell.research.action_title": "Next step",
        "product_shell.research.evidence_what": "What changed",
        "product_shell.research.evidence_support": "Strongest support",
        "product_shell.research.evidence_counter": "Counter / companion view",
        "product_shell.research.evidence_missing": "Missing or preparing evidence",
        "product_shell.research.evidence_peer": "Peer cases in the same family",
        "product_shell.research.action_open_replay": "See it in Replay",
        "product_shell.research.action_ask_ai": "Ask AI about this",
        "product_shell.research.action_back_today": "Back to Today",
        "product_shell.research.empty_tiles": "No grounded perspectives to show for this horizon yet.",
        "product_shell.research.missing_badge": "preparing",
        "product_shell.replay.title": "How we got here",
        "product_shell.replay.summary_events": "events",
        "product_shell.replay.summary_span": "span",
        "product_shell.replay.timeline_title": "Timeline of changes",
        "product_shell.replay.scenarios_title": "Scenarios",
        "product_shell.replay.scenario_baseline": "Today's reading",
        "product_shell.replay.scenario_weakened": "If the evidence weakens",
        "product_shell.replay.scenario_stressed": "If the market turns",
        "product_shell.replay.gap_days": "day gap",
        "product_shell.replay.checkpoint_decision": "Decision point",
        "product_shell.replay.advanced_label": "Raw payload (redacted)",
        "product_shell.replay.advanced_hint": "Raw internal identifiers and payload are available in the operator view (/ops).",
        "product_shell.replay.back_to_today": "Back to Today",
        "product_shell.replay.empty_timeline": "No governance history to show for this asset yet.",
        "product_shell.replay.scenario_hint_title": "Scenarios are sensitivity checks, not decisions.",
        "product_shell.replay.scenario_hint_body": "None of these are buy or sell guidance.",
        "product_shell.ask.context_prefix": "What you're looking at",
        "product_shell.ask.quick_title": "Common questions",
        "product_shell.ask.freetext_title": "Ask in your own words",
        "product_shell.ask.freetext_placeholder": "e.g., Why is this signal stronger than before?",
        "product_shell.ask.submit": "Ask",
        "product_shell.ask.answer_claim": "Summary answer",
        "product_shell.ask.answer_evidence": "Evidence",
        "product_shell.ask.answer_missing": "What's missing",
        "product_shell.ask.degraded_banner": "The automated answerer is preparing right now. Here is the evidence we can cite.",
        "product_shell.ask.requests_title": "Your requests",
        "product_shell.ask.requests_empty": "You haven't sent any requests yet.",
        "product_shell.ask.back_to_today": "Back to Today",
        "product_shell.ask.intent.explain_claim": "Explain this perspective more fully",
        "product_shell.ask.intent.show_support": "What is the strongest support?",
        "product_shell.ask.intent.show_counter": "What is the counter / companion view?",
        "product_shell.ask.intent.other_horizons": "How do other horizons see this?",
        "product_shell.ask.intent.why_confidence": "Why this level of confidence?",
        "product_shell.ask.intent.whats_missing": "What evidence is missing?",
